/****************************************************************************************/
/* CSE 5462 - Lab 2                                                                     */
/*      This program implements the client end of the file server which given a server  */
/*      ip address, port number and file to transfer sends the specified file to the    */
/*      server using TCP Stream socket.                                                 */
/*                                                                                      */
/* Name: Ishan Deep                                                                     */
/* Lname.#: deep.24                                                                     */
/*                                                                                      */
...
{
    if (filePath && strrchr(filePath, '/') != NULL)
